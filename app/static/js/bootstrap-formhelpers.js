...
+function ($) {
  ...
  BFHCountries.prototype = {
      ...
      for (country in countries) {
        if (countries.hasOwnProperty(country)) {
          if (this.options.flags === true) {
            $options.append('<li><a tabindex="-1" href="#" data-option="' + country + '"><i class="icon bfh-flag-' + country + '"></i>' + countries[country] + '</a></li>');
          } else {
    ...
    displayCountry: function () {
      ...
      if (this.options.flags === true) {
        this.$element.html('<i class="icon bfh-flag-' + value + '"></i> ' + BFHCountriesList[value]);
      } else {
  ...
  BFHCurrencies.prototype = {
      ...
      for (currency in currencies) {
        if (currencies.hasOwnProperty(currency)) {
          if (this.options.flags === true) {
            ...
            $options.append('<li><a tabindex="-1" href="#" data-option="' + currency +  '"><i class="icon bfh-flag-' + flag + '"></i>' + currencies[currency].label + '</a></li>');
          } else {
    ...
    displayCurrency: function () {
      ...
      if (this.options.flags === true) {
        ...
        this.$element.html('<i class="icon bfh-flag-' + flag + '"></i> ' + BFHCurrenciesList[value].label);
      } else {
  ...
  BFHDatePicker.prototype = {
    ...
    initCalendar: function() {
      ...
      this.$element.html(
        ...
        '<a class="previous" href="#"><i class="icon icon-chevron-left"></i></a>' +
        '<span></span>' +
        '<a class="next" href="#"><i class="icon icon-chevron-right"></i></a>' +
        '</th>' +
  ...
  BFHLanguages.prototype = {
    ...
    addBootstrapLanguages: function() {
      ...
      for (language in languages) {
        if (languages.hasOwnProperty(language)) {
          if (languages[language].hasOwnProperty('name')) {
            if (this.options.flags === true) {
              $options.append('<li><a tabindex="-1" href="#" data-option="' + language + '_' + languages[language].country + '"><i class="icon bfh-flag-' + languages[language].country + '"></i>' + languages[language].name.toProperCase() + '</a></li>');
            } else {
    ...
    displayLanguage: function () {
      ...
      if (value.indexOf('_') !== -1) {
        value = value.split('_');
        if (this.options.flags === true) {
          this.$element.html('<i class="icon bfh-flag-' + value[1] + '"></i> ' + BFHLanguagesList[value[0]].toProperCase());
        } else {
  ...
  BFHNumber.prototype = {
    ...
    initInput: function() {
      ...
      if (this.options.buttons === true) {
        ...
        this.$element.parent().append('<span class="input-group-addon bfh-number-btn inc"><span class="icon icon-chevron-up"></span></span>');
        this.$element.parent().append('<span class="input-group-addon bfh-number-btn dec"><span class="icon icon-chevron-down"></span></span>');
      }
